...
/// <summary>
/// Declares a literal text rule to be compiled into a text rewrite plan.
/// </summary>
[AttributeUsage(AttributeTargets.Method, AllowMultiple = true)]
public sealed class TextLiteralRuleAttribute(string pattern) : Attribute
{
    /// <summary>
    ...
    /// <summary>
    /// Comparison mode for literal matching.
    /// </summary>
