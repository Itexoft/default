...
public abstract class AtomicRam<T>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private protected bool FreeDense(nuint ptr) => this.TryFreeDense(ptr, false);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private protected bool FreeDense(nuint ptr, out T value) => this.TryFreeDense(ptr, false, out value);
    ...
    private bool TryFreeDense(nuint ptr, bool trackLive)
    {
        ...
        if (!this.TryGetLiveNext(portal, out var child) || !child.TryFreeDense(next, true))
            return false;
    ...
    private bool TryFreeDense(nuint ptr, bool trackLive, out T value)
    {
        ...
        if (!this.TryGetLiveNext(portal, out var child) || !child.TryFreeDense(next, true, out value))
        {
            value = default!;
