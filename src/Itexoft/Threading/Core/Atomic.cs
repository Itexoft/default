...
/// <summary>
/// Small set of atomic helpers around <see cref="Interlocked" />/<see cref="Atomic" />.
/// </summary>
public static unsafe class Atomic
{
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T Read<T>(ref T location) => Internal<T>.Read(ref location);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void* Read(ref nint location) => (void*)Interlocked.CompareExchange(ref location, nint.Zero, nint.Zero);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T Write<T>(ref T location, T value) => Internal<T>.Write(ref location, value);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T* Write<T>(ref T* location, T* value) where T : unmanaged
    {
        fixed (T** ptr = &location)
            return (T*)Interlocked.Exchange(ref *(nint*)ptr, (nint)value);
    }
    ...
    public static bool ExchangeIfGreaterThan(ref long location, long value, long comparison, out long originalValue, out long newValue)
    {
        do
        {
            originalValue = Read(ref location);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void Exchange(ref long location, void* state, delegate*<long, void*, long> getValue, out long originalValue, out long newValue)
    {
        if (getValue == null)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T Exchange<T>(ref T location, T value) => Interlocked.Exchange(ref location, value);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool NullOut<T>(ref T? location, [NotNullWhen(true)] out T? prev) where T : class
    {
        prev = Interlocked.Exchange(ref location, null);

        return prev is not null;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNull<T>(ref T? location) where T : class => Interlocked.CompareExchange(ref location, null, null) is null;
    ...
    {
        //private static readonly bool isReference = RuntimeHelpers.IsReferenceOrContainsReferences<T>();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T Write(ref T location, T value) => Interlocked.Exchange(ref location, value);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T Read(ref T location) => Interlocked.CompareExchange(ref location, default!, default!);
    }
}
