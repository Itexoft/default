...
public sealed class InlineLaneCombiner64<TState, TRequest, TResult, TOp> where TOp : struct, ILaneOp64<TState, TRequest, TResult>
{
    ...
    public InlineLaneCombiner64(TState state) => this.state = state;
