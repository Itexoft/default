...
public static class Atomic64Ops
{
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ulong Read(ref ulong location) => Atomic.Read(ref location);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void Write(ref ulong location, ulong value) => Atomic.Write(ref location, value);
    ...
    {
        var original = Atomic.Read(ref location);
...
public static class Atomic32
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void Read(ref ulong location, out int low, out int high) => Unpack(Atomic.Read(ref location), out low, out high);
