...
public sealed class NetHttpHeaders : IEnumerable<KeyValuePair<string, string>>
{
    ...
    public ConnectionType ConnectionType
    {
        get
        {
            if (!this.TryGetValue("Connection", out var value))
                return ConnectionType.None;

            if (NetHttpParsing.ContainsToken(value, "keep-alive"))
                return ConnectionType.KeepAlive;

            if (NetHttpParsing.ContainsToken(value, "close"))
                return ConnectionType.Close;

            return ConnectionType.Unknown;
        }
        set => this.Connection = value switch
        {
    ...
    public Encoding ContentTypeEncoding
    {
        get
        {
            var charset = this.ContentType.Charset;
    ...
    public void ApplyDefaults(NetHttpHeaders headers)
    {
