...
public readonly record struct NetHttpRequest(NetHttpMethod method, NetHttpPathQuery pathAndQuery, NetHttpVersion version, NetHttpHeaders headers)
{
    ...
    public static bool operator ==(NetHttpRequest left, string right) => new NetHttpMatch(left, 0, true) == right;

    public static bool operator !=(NetHttpRequest left, string right) => !(left == right);

    public static NetHttpMatch operator /(NetHttpRequest left, string right) => new NetHttpMatch(left, 0, true) / right;
}
