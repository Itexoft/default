...
public readonly struct NetIpEndpoint(NetIpAddress ipAddress, NetPort port, NetProtocol protocol = NetProtocol.Unknown)
{
    ...
    public static implicit operator NetIpEndpoint((NetIpAddress IpAddress, NetPort Port, NetProtocol protocol) endpoint) => new(endpoint.IpAddress, endpoint.Port,endpoint.protocol);
