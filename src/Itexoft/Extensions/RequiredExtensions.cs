...
public static class RequiredGreaterOrLessOrEqualExtensions
{
    ...
    public static byte RequiredLess(this byte value, byte max, [CallerArgumentExpression(nameof(value))] string? name = null)
    {
        if (value >= max)
            throw new ArgumentOutOfRangeException(name, value, "Value is out of range.");
    ...
    public static ulong RequiredLess(this ulong value, ulong max, [CallerArgumentExpression(nameof(value))] string? name = null)
    {
        if (value >= max)
            throw new ArgumentOutOfRangeException(name, value, "Value is out of range.");
