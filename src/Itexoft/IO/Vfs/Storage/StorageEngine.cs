...
internal sealed class StorageEngine : IDisposable
{
    ...
    private static readonly ConditionalWeakTable<System.IO.Stream, object> streamGates = new();
    private readonly byte[] fallbackSuperblock;
    private readonly object ioGate;
    private readonly System.IO.Stream? mirrorStream;
    ...
    private StorageEngine(System.IO.Stream stream, System.IO.Stream? mirrorStream, int pageSize, bool ownsMirrorStream)
    {
        this.stream = stream;
    ...
    public static StorageEngine Open(System.IO.Stream stream, int pageSize)
    {
    ...
    public static StorageEngine OpenMirrored(System.IO.Stream primary, System.IO.Stream mirror, int pageSize, bool ownsMirrorStream)
    {
