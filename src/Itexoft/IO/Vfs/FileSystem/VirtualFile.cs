...
public static class VirtualFile
{
    ...
    public static System.IO.Stream Open(VirtualFileSystem vfs, string path, FileMode mode, FileAccess access)
    {
        vfs.Required();
    ...
    public static System.IO.Stream OpenRead(VirtualFileSystem vfs, string path) => Open(vfs, path, FileMode.Open, FileAccess.Read);

    public static System.IO.Stream OpenWrite(VirtualFileSystem vfs, string path) => Open(vfs, path, FileMode.OpenOrCreate, FileAccess.Write);
