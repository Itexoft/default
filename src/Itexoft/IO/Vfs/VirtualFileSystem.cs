...
public sealed class VirtualFileSystem : IDisposable
{
    ...
    private VirtualFileSystem(System.IO.Stream baseStream, VirtualFileSystemOptions options)
    {
        ...
        System.IO.Stream? mirrorStream = null;
    ...
    internal System.IO.Stream UnderlyingStream { get; }
    ...
    public static VirtualFileSystem Mount(System.IO.Stream stream, VirtualFileSystemOptions? options = null) =>
    ...
    /// <returns>A <see cref="System.IO.Stream" /> representing the file.</returns>
    public System.IO.Stream OpenFile(string path, FileMode mode, FileAccess access)
    {
        ...
        var exists = this.TryResolveEntry(segments, out var resolvedParentId, out var entry);
