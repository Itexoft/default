...
{
    private readonly IniEntryCollection entries;
    ...
    public IniEntryCollection Entries => this.entries;
    ...
    private static Dictionary<string, IniValueCollection> BuildValueIndex(
        IEnumerable<IniEntry> entries,
        StringComparer keyComparer)
    {
